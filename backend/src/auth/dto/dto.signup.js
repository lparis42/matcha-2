...
var SignUpDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _email_decorators = [(0, decorator_dto_js_1.verifyEmail)(), (0, decorator_dto_js_1.verifyLength)(6, 255)];
            _username_decorators = [(0, decorator_dto_js_1.verifyName)(), (0, decorator_dto_js_1.verifyLength)(6, 20)];
            _password_decorators = [(0, decorator_dto_js_1.verifyPassword)(), (0, decorator_dto_js_1.verifyLength)(8, 64)];
            _first_name_decorators = [(0, decorator_dto_js_1.verifyName)(), (0, decorator_dto_js_1.verifyLength)(3, 20)];
            _last_name_decorators = [(0, decorator_dto_js_1.verifyName)(), (0, decorator_dto_js_1.verifyLength)(3, 20)];
